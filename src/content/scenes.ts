...
export const scenes: ExplorerScene[] = [
  {
    ...
    hotspots: [
      { id: 'monitor', label: 'Monitore', x: 47.5, y: 44, target: { type: 'bereich', slug: 'monitore' } },
      { id: 'pc', label: 'In den PC schauen', x: 90, y: 57, target: { type: 'scene', id: 'pc-innen' } },
      { id: 'tastatur', label: 'Tastaturen', x: 45.8, y: 81.5, target: { type: 'bereich', slug: 'tastaturen' } },
      { id: 'maus', label: 'Mäuse', x: 64.8, y: 82, target: { type: 'bereich', slug: 'maeuse' } },
      { id: 'headset', label: 'Headsets', x: 12, y: 67.5, target: { type: 'bereich', slug: 'headsets' } },
      { id: 'mikrofon', label: 'Mikrofone', x: 17.5, y: 44.5, target: { type: 'bereich', slug: 'mikrofone' } },
      { id: 'speaker', label: 'Lautsprecher', x: 21.6, y: 67.5, target: { type: 'bereich', slug: 'lautsprecher' } },
    ],
  },
  {
    id: 'pc-innen',
